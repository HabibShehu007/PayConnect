  ...
  return (
    ...
    >
      <div className="bg-white text-violet-700 rounded-2xl p-6 max-w-md w-full text-center shadow-2xl">
        <FaThumbsUp className="text-green-500 text-6xl mx-auto mb-4" />
        <h2 className="text-2xl font-extrabold mb-2">Transaction Approved</h2>
        <p className="text-lg font-bold tracking-tight mb-4">{message}</p>
        <button
          onClick={onClose}
